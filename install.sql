...
(
    ...
    `usage`       tinyint(4)       NOT NULL COMMENT '用途，1.充值，2.购买vip，3.购买章节，4.奖励',
...
-- ----------------------------
-- Table structure for xwx_rewards
-- ----------------------------
DROP TABLE IF EXISTS `xwx_rewards`;
CREATE TABLE `xwx_rewards`
(
    `id`          int(10) unsigned NOT NULL AUTO_INCREMENT,
    `rname`       varchar(100)     NOT NULL DEFAULT 0 COMMENT '奖励名称',
    `money`       decimal(10, 2)   NOT NULL DEFAULT 0 COMMENT '奖励金额',
    `create_time` int(11)                   DEFAULT '0',
    `update_time` int(11)                   DEFAULT '0',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
